...
export default function FoodBar() {
  return (
    <div className="w-full h-[50px] mb-14 bg-[#ffdabb] dark:bg-gray-800 text-[#7a472a] dark:text-gray-300 flex justify-around items-center px-4 overflow-hidden text-base max-[600px]:text-sm max-[400px]:text-xs font-sans">
