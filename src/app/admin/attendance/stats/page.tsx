    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
        ...
        <div className="flex gap-2 items-center">
          ...
          />
          <button onClick={fetchStats} className="btn-primary">Actualiser</button>
        </div>
      </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium uppercase">Jours travaillés</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {stats.map((emp) => (
                <tr key={emp.id}>
                  ...
                  <td className="px-4 py-3 text-green-600">{emp.presenceDays}</td>
                  <td className="px-4 py-3 text-red-600">{emp.absenceDays}</td>
