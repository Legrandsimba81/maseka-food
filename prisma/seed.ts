...
async function main() {
  ...
  console.log(`🗑️ ${deleteResult.count} produits supprimés`)
  ...
  const products = [
    ...
    { name: 'Donate 1000 FC', description: 'Donate grand', price: fcToUsd(1000), category: 'snacks', imageUrl: '/images/produits/donate-1000fc.jpg' },
